...
import ua.com.proteus.dao.GraphicDao;
import ua.com.proteus.dao.MemoryDao;
import ua.com.proteus.dao.ProducerDao;
import ua.com.proteus.dao.UserDao;
import ua.com.proteus.entity.Graphic;
import ua.com.proteus.entity.Memory;
import ua.com.proteus.entity.Producer;
import ua.com.proteus.service.FileWriter;
import ua.com.proteus.service.GraphicService;
import ua.com.proteus.specification.GraphicSpecification;
import ua.com.proteus.service.FileWriter.Folder;
...
public class GraphicServiceImpl implements GraphicService  {
	...
	public void save(GraphicForm form) {
		...
		entity.setFrequency(new Integer(form.getFrequency()));
		entity.setData_bus(new Integer(form.getData_bus()));
		entity.setMemory_value(new Integer(form.getMemory_value()));
	...
	public Graphic findUnique(String name, String frequency, String data_bus, String memory_value, String price, Memory memory, Producer producer) {
		return graphicDao.findUnique(name, new Integer(frequency), new Integer(data_bus), new Integer(memory_value) ,new BigDecimal(price.replace(',', '.')), memory.getId(), producer.getId());
	}
